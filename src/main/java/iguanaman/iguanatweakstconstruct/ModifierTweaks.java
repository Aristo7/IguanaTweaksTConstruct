...
//		}
		...
		ToolBuilder.registerToolMod(new ModDurability(new ItemStack[] { new ItemStack(Items.emerald) }, 1, 0, 0.5f, ModifierConfig.emeraldboost, "Emerald", "\u00a72Durability +50%", "\u00a72"));
		if (ModifierConfig.diamondPickaxeBoost)
		{
			ToolBuilder.registerToolMod(new ModDurability(new ItemStack[] { new ItemStack(Items.diamond) }, 0, 500, 0f, Blocks.obsidian.getHarvestLevel(0), "Diamond", "\u00a7bDurability +500", "\u00a7b"));
		} else {
